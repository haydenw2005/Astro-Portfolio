...
export function FileTree() {
  ...
  return (
    <div className="relative flex h-screen flex-col items-center justify-center rounded-lg sticky top-0 z-50 w-60">
      <Tree
        className={`p-2 rounded-md text-white purpleGlow mt-8`}
        initialSelectedId="2"
        ...
        elements={ELEMENTS}
      >
        <p className="text-purple-300 glow-purple text-xl">
          {" "}
